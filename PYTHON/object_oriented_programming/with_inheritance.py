...
class Rectangle(Shape):
    ...
    def __init__(self, length, width):
        ...
        # self <specific object created from the class>
...
print("Area is", r1.area())  # coming from the Rectangle class
...
print("Area is", s1.area())  # coming from the Rectangle class
...
# Different shape objects use the same method names.
# Each shape can have its own version of area() and perimeter().
